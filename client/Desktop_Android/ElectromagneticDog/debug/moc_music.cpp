...
QT_MOC_LITERAL(1, 6, 16), // "slotSortFinished"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 14), // "QNetworkReply*"
QT_MOC_LITERAL(4, 39, 18) // "slotGetUrlFinished"

    },
    "Music\0slotSortFinished\0\0QNetworkReply*\0"
    "slotGetUrlFinished"
};
...
void Music::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotSortFinished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 1: _t->slotGetUrlFinished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
